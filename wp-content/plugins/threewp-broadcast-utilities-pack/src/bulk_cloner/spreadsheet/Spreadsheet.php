	...
	extends \threewp_broadcast\premium_pack\base
{
	...
	**/
	public function create_export_file( $options )
	{
		...
		$foreground_color = new \PhpOffice\PhpSpreadsheet\Style\Color();
		...
		$objWriter = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter( $ss, 'Xls' );
	...
	**/
	public function import_file( $options )
	{
		...
		$inputFileType = \PhpOffice\PhpSpreadsheet\IOFactory::identify( $options->filename );
