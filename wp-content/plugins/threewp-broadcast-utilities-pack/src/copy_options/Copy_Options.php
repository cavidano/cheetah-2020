	...
	**/
	public function copy_ui()
	{
		...
		if ( $form->is_posting() )
		{
			...
			{
				$action = $this->new_action( 'do_copy' );
...
namespace
{
	/**
		...
		@since		2020-02-27 17:40:20
	**/
	function broadcast_copy_options()
	{
		return \threewp_broadcast\premium_pack\copy_options\Copy_Options::instance();
	}
}
