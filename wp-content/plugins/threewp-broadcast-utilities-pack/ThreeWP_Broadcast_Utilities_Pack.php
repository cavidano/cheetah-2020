...
Description:	Utilities related to broadcasting.
Plugin Name:	Broadcast Utilities Pack
Plugin URI:		https://broadcast.plainviewplugins.com
Version:		47.07
*/

define( 'BROADCAST_UTILITIES_PACK_VERSION', 47.07 );

/**
	@brief		This class handles the loading of the pack.
	@since		2015-10-29 15:37:13
**/
class threewp_broadcast_utilities_pack_loader
{
	/**
	...
	**/
	public function pack()
	{
		if ( $this->plugin_pack === false )
		{
			...
			new \threewp_broadcast\premium_pack\ThreeWP_Broadcast_Utilities_Pack();
		}
		return $this->plugin_pack;
	}
}

new threewp_broadcast_utilities_pack_loader();
